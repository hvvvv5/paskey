  ...
  return (
    <div className="px-5 pb-28 pt-5">
      <div className="flex items-center gap-3">
        ...
        <h1 className="font-heading text-xl text-white">{t(cat.label)}</h1>
      ...
      <div className="mt-5 space-y-2">
        {items === null ? (
          <p className="py-10 text-center text-sm text-[#AEB4BE]">{t('Decrypting…')}</p>
        ) : items.length === 0 ? (
          <p className="py-10 text-center text-sm text-[#AEB4BE]">{t('Nothing saved here yet.')}</p>
