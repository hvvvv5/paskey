...
export default function Settings() {
  ...
  return (
    <div className="px-5 pb-32 pt-6">
      <div>
        <div>
          <p className="text-xs uppercase tracking-[0.24em] text-[#C8A96B]">PasKey preferences</p>
          <h1 className="mt-1 font-heading text-2xl text-white">Settings</h1>
        </div>
      </div>
      ...
      <Row>
        <span className="flex min-w-0 flex-1 items-center gap-2 text-white"><Fingerprint className="h-4 w-4 text-[#C8A96B]" />Biometric unlock</span>
      ...
      <h2 className="mt-8 text-xs uppercase tracking-widest text-[#AEB4BE]">Appearance</h2>
      <Row>
        <label htmlFor="theme" className="flex-1 text-white">Color theme</label>
        <select
          id="theme"
      ...
      <Link to="/privacy" className="flex items-center gap-3 border-b border-white/5 py-4 text-sm text-white"><span className="flex-1">Privacy & local data</span><ChevronRight className="h-4 w-4 text-[#AEB4BE]" /></Link>
